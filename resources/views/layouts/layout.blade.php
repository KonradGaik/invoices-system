  ...
  <nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="{{url('/welcome')}}" class="brand-logo">Fakturomat</a>
     ...
     <li><a href="{{route('faktury')}}">Lista faktur</a></li>
      @Auth  <li><a href="{{route('utworz')}}">Utwórz fakture</a></li>@endAuth
        <li><a href="{{route('klienci.index')}}">Lista klientów</a></li>
     @Auth   <li><a href="{{route('klienci.create')}}">Dodaj klienta</a></li> @endAuth
        @guest<li><a href="{{ route('login') }}">Zaloguj</a></li>
        <li><a href="{{ route('register') }}">Zarejerstruj</a></li>
        @endguest
      ...
      <li><a href="#">Witaj @Auth{{ Auth::user()->name }}@endAuth
            @guest gość @endguest </a> 
      </li> 
      ...
      <a href="#" data-target="nav-mobile" class="sidenav-trigger">  <i class="add_box">Menu</i></a>
    </div>
  </nav>
